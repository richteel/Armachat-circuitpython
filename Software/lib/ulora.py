...
class LoRa(object):
    def __init__(self, spi, CS, this_address=[0, 0, 0, 0], hop_limit=3, freq=868.0, tx_power=14,
...
#        gpio_interrupt = Pin(self._interrupt, Pin.IN, Pin.PULL_DOWN)
    ...
    def send(self, to_address, data, message_id=[]):
